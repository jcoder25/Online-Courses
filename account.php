...
<html lang="en">
    ...
    <body>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <b>Attention</b>: Free Websites Are For limited Users <u><a href="account.php">ORDER US NOW.!.</u></a></a><br><br>
                        <div class="form-group form-check">
                        <input type="checkbox" class="form-check-input" id="exampleCheck1">
                        <label class="form-check-label" for="exampleCheck1"> I have Checked Your Free Web Templates.</label>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                        <a  class="btn btn-primary" href="home.html">Yes</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
            ...
            <p class="lead text-capitalize ">Quickly build an effective and Secured Website for your potential customers with  <a href="home.html">Code With @jashan.</a> Having a website and online presence strategy allows you to market your business online.</p>
        </div>
                ...
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mt-3 mb-4">
                            <li>2 Websites For free</li>
                            <li>*Free Web Templates*</li>
                            <li>Upto 10 Webpages each</li>
                            <li>Email support</li>
                ...
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mt-3 mb-4">
                            ...
                            <li>Bussiness Websites</li>
                            <li>*Hosting On Google Cloud*</li>
                            <li>15 GB of storage each</li>
                            <li>Gateway Support</li>
            ...
            <footer class="pt-4 my-md-5 pt-md-5 border-top">
                <div class="row">
                    <div class="col-12 col-md">
                        <img class="mb-3" src="logo.png" alt="img" width="60" height="60">
